...
// ─────────────────────────────────────────────────────────────────────────────
// /agent/explain modal + Overview hero
//
// Moved to sibling translation units:
//   * UI/SShintToolsPanel_Explain.cpp  — TickExplainStatus, OnExplainIssueClicked,
//                                        OnExplainComplete (3 methods, modal SWindow,
//                                        ticker handle)
//   * UI/SShintToolsPanel_Overview.cpp — BuildOverviewHero (4-up KPI grid)
//
// Both blocks were self-contained (state lives entirely on the
// panel member set; nothing else in this file reaches into the
// modal's ticker or the hero's tile lambdas) so splitting them
// out trims this TU by ~380 lines without touching behaviour
// or callsites.
// ─────────────────────────────────────────────────────────────────────────────
