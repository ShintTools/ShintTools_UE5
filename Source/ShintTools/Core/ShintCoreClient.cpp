...
// External Web Dashboard "Send to ..." paths moved to
// Core/ShintDashboardSync.cpp. The free SKU never builds those buttons,
// so isolating the code in a separate TU lets unused-symbol elimination
// drop the corresponding lambdas from the binary.
...
// ─────────────────────────────────────────────────────────────────────────────
// Slice B — Quality Score endpoints
// ─────────────────────────────────────────────────────────────────────────────
	...
	FShintQualityScoreSnapshot& Out)
{
	...
	{
		// Server responded with no overall_score → treat as missing.
		return false;
	}
...
// SendAssetNamingToDashboard moved to FShintDashboardSync (see above
// note next to the code-validator path).
